...
# 📖 [Database-on-diagram] <a name="about-project"></a>

**[Database-on-diagram]** Is interpreted, and implemented a database diagram with the SQL needed to build that database.
...
```sh
  cd Database-on-diagram
  git clone https://github.com/HERMON-1995/Database-on-diagram.git
```
...
Feel free to check the [issues page](https://github.com/HERMON-1995/Database-on-diagram/issues).
